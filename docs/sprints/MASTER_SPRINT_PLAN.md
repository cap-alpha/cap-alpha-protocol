...
- [/] SP29-1: Enforce strict BigQuery `NOT NULL` constraints and foreign key mappings across all core identity tables (Players, Teams, Contracts). (GH-#106) (Claimed by Agent claude-sonnet-4-6)
