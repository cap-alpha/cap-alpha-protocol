...
def ingest_historical_injuries():
    ...
    try:
        ...
        logger.info(
            f"Successfully aggregated {len(df_injuries)} injury records for 2018-2024."
        )
        ...
        logger.info(
            "Persisting raw unstructured injury strings to MotherDuck: bronze_layer.nflverse_injuries"
        )
