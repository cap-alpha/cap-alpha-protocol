...
#
# Required env vars: GH_APP_ID, GH_INSTALLATION_ID
# Optional env vars: GH_APP_PEM (default: $HOME/.ghconfig/triage-app.pem)

set -euo pipefail

APP_ID="${GH_APP_ID:-3545386}"
INSTALLATION_ID="${GH_INSTALLATION_ID:?GH_INSTALLATION_ID must be set (GitHub App installation ID for the target org)}"
