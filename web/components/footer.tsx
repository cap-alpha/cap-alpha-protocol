            ...
            <div className="py-8 px-4">
                <div className="max-w-7xl mx-auto flex flex-col items-center justify-center space-y-4">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-4 text-slate-300 text-xs mb-2">
                        ...
                        <Link href="/verify" className="min-h-[44px] inline-flex items-center hover:text-emerald-400 transition-colors font-medium">Verify Ledger</Link>
                    </div>
                    <div className="flex flex-wrap items-center justify-center gap-4 text-slate-400 text-xs">
                        <Link href="/methodology" className="min-h-[44px] inline-flex items-center hover:text-emerald-400 transition-colors">Methodology</Link>
                        ...
                        <Link href="/legal/responsible-gambling" className="min-h-[44px] inline-flex items-center hover:text-amber-400 transition-colors text-amber-500">Responsible Gambling</Link>
                        ...
                        <Link href="/status" className="min-h-[44px] inline-flex items-center hover:text-slate-300 transition-colors">Status</Link>
                    </div>
