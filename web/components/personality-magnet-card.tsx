        ...
        <div id="personality-magnet-card" className={`relative overflow-hidden rounded-2xl border ${borderColor} ${gradient} p-8 shadow-2xl`}>
            ...
            <div className="relative z-10 mt-14 grid grid-cols-2 gap-4">
                <div className="bg-black/40 backdrop-blur-md rounded-xl p-5 border border-white/5 shadow-inner">
                    <p className="text-[10px] uppercase font-bold tracking-widest text-zinc-400 mb-1.5">Cap Burden</p>
                    <p className="text-3xl font-mono font-bold text-white">
                        ${player.cap_hit_millions?.toFixed(1) || '0.0'}M
                    </p>
                </div>
                <div className="bg-black/40 backdrop-blur-md rounded-xl p-5 border border-white/5 shadow-inner">
                    <p className="text-[10px] uppercase font-bold tracking-widest text-zinc-400 mb-1.5">Fair Market Value</p>
                    <p className="text-3xl font-mono font-bold text-white">
                        {player.fair_market_value != null ? `$${player.fair_market_value.toFixed(1)}M` : '—'}
                    </p>
                </div>
                <div className="bg-black/40 backdrop-blur-md rounded-xl p-5 border border-white/5 shadow-inner">
                    <p className="text-[10px] uppercase font-bold tracking-widest text-zinc-400 mb-1.5">ML Risk Score</p>
                ...
                <div className="bg-black/40 backdrop-blur-md rounded-xl p-5 border border-white/5 shadow-inner flex flex-col justify-center">
                    <p className="text-[10px] uppercase font-bold tracking-widest text-zinc-400 mb-1.5">Market Thesis</p>
